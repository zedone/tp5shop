<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:67:"D:\wamp64\www\test\b2cshop/application/admin\view\category\edit.htm";i:1560511783;s:64:"D:\wamp64\www\test\b2cshop/application/admin\view\common\top.htm";i:1517578989;s:65:"D:\wamp64\www\test\b2cshop/application/admin\view\common\left.htm";i:1560414868;}*/ ?>
<!DOCTYPE html>
<html><head>
        <meta charset="utf-8">
                ...
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <?php foreach($searchAttrArr as $k=>$v):
                                    if($k == 0){
                                        $opt = '[+]';
                                    }else{
                                        $opt = '[-]';            
