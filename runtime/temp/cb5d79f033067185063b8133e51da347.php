<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:66:"E:\wamp64\www\test\b2cshop/application/admin\view\article\edit.htm";i:1510205422;s:64:"E:\wamp64\www\test\b2cshop/application/admin\view\common\top.htm";i:1517578989;s:65:"E:\wamp64\www\test\b2cshop/application/admin\view\common\left.htm";i:1560414868;}*/ ?>
<!DOCTYPE html>
<html><head>
        <meta charset="utf-8">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <select name="cate_id">
                                    ...
                                    <option <?php if($arts['cate_id'] == $cate['id']): ?> selected="selected" <?php endif; if(in_array(($cate['id']), explode(',',"1,2"))): ?> disabled="disabled" <?php endif; ?> value="<?php echo $cate['id']; ?>"><?php echo str_repeat('-', $cate['level']*8)?><?php echo $cate['cate_name']; ?></option>
