<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:66:"D:\xammp\htdocs\test\b2cshop/application/admin\view\order\edit.htm";i:1560408866;s:66:"D:\xammp\htdocs\test\b2cshop/application/admin\view\common\top.htm";i:1517578989;s:67:"D:\xammp\htdocs\test\b2cshop/application/admin\view\common\left.htm";i:1560414868;}*/ ?>
<!DOCTYPE html>
<html><head>
        <meta charset="utf-8">
            ...
            <form method="post" action="<?php echo url('Order/edit'); ?>">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php echo $orderInfo['out_trade_no']; ?></td>
                    </tr>
                    <tr>
                        <td style="text-align: right">下单用户</td>
                        <td>
                            <input type="text" value="<?php echo $orderInfo['username']; ?>" name="username">
                        </td>
                    </tr>
                    <tr>
                        <td style="text-align: right">总金额</td>
                        <td><input type="text" value="<?php echo $orderInfo['goods_total_price']; ?>" name="username"></td>
                    </tr>
                    <tr>
                        <td style="text-align: right">订单金额</td>
                        <td><?php echo $orderInfo['order_total_price']; ?></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <select name="distribution">
                                <option value="">请选择</option>
                                <option <?php if($orderInfo['distribution'] == '申通'): ?> selected="selected" <?php endif; ?> value="1">申通</option>
                                <option <?php if($orderInfo['distribution'] == '顺丰'): ?> selected="selected" <?php endif; ?>  value="2">顺丰</option>
                            </select>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <select name="order_status">
                                ...
                                <option <?php if($orderInfo['order_status'] == 1): ?> selected="selected"<?php endif; ?>  value="2">申请退款</option>
                                <option <?php if($orderInfo['order_status'] == 1): ?> selected="selected"<?php endif; ?>  value="3">退款成功</option>
                            </select>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <select name="distribution">
                                <option value="">请选择</option>
                                <option <?php if($orderInfo['pay_status'] == 0): ?> selected="selected" <?php endif; ?> value="0">未支付</option>
                                <option <?php if($orderInfo['pay_status'] == 1): ?> selected="selected" <?php endif; ?>  value="1">已确认</option>
                            </select>
                        </td>
                    </tr>
                    <tr>
                        <td style="text-align: right">发货状态</td>
                        <td>
                            <select name="post_status">
                                ...
                                <option <?php if($orderInfo['post_status'] == 2): ?> selected="selected" <?php endif; ?>  value="1">已收货</option>
                            </select>
                        </td>
                    </tr>
                    <tr>
                        <td style="text-align: right">运费</td>
                        <td><input type="text" name="post_spent" value="<?php echo $orderInfo['post_spent']; ?>"></td>
                    </tr>
                    <tr>
                        <td style="text-align: right">收货人</td>
                        <td><input type="text" name="name" value="<?php echo $orderInfo['name']; ?>"></td>
                    </tr>
                    <tr>
                        <td style="text-align: right">手机号</td>
                        <td><input type="text" name="phone" value="<?php echo $orderInfo['phone']; ?>"></td>
                    </tr>
                    <tr>
                        <td style="text-align: right">省份</td>
                        <td><input type="text" name="province" value="<?php echo $orderInfo['province']; ?>"></td>
                    </tr>
                    <tr>
                        <td style="text-align: right">地址</td>
                        <td><input type="text" name="address" value="<?php echo $orderInfo['address']; ?>"></td>
                    </tr>
                    <tr>
                        <td style="text-align: right">下单时间</td>
                        <td><input type="text" name="order_time" value="<?php echo date("Y-m-d H:i:s",$orderInfo['order_time'])?>"></td>
                    </tr>
                    <tr>
                        <td style="text-align: right">订单商品</td>
                        <td>2</td>
                    </tr>
                </tbody>
                    <input type="submit" class="btn btn-class" value="提交修改" name="">
                </form>
