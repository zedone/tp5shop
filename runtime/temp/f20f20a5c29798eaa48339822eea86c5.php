<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:66:"E:\wamp64\www\test\b2cshop/application/admin\view\order\detail.htm";i:1560253602;s:64:"E:\wamp64\www\test\b2cshop/application/admin\view\common\top.htm";i:1517578989;s:65:"E:\wamp64\www\test\b2cshop/application/admin\view\common\left.htm";i:1560249797;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
            ...
            <table class="table table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php echo $orderInfo['goods_total_price']; ?></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><?php if($orderInfo['distribution'] == 1): ?>
                                申通
                            <?php else: ?>
                                顺丰
                            <?php endif; ?>
                    ...
                    <tr>
                        ...
                        <td><?php if($orderInfo['order_status'] == 0): ?>
                                未确认
                            <?php elseif($orderInfo['order_status'] == 1): ?>
                                已确认
                    ...
                    <tr>
                        ...
                        <td><?php if($orderInfo['pay_status'] == 0): ?>
                                未支付
                            <?php else: ?>
                                已支付
                            <?php endif; ?>
                    ...
                    <tr>
                        ...
                        <td><?php if($orderInfo['post_status'] == 0): ?>
                                未发货
                            <?php elseif($orderInfo['post_status'] == 1): ?>
                                已发货
                            <?php elseif($orderInfo['post_status'] == 2): ?>
                                已收货                           
                            <?php endif; ?>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td><?php echo $orderInfo['post_spent']; ?></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><?php echo date("Y-m-d H:i:s",$orderInfo['order_time'])?></td>
                    </tr>
                    <tr>
