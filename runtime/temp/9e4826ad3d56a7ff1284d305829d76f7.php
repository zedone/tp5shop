<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:63:"E:\wamp64\www\test\b2cshop/application/admin\view\conf\edit.htm";i:1511342771;s:64:"E:\wamp64\www\test\b2cshop/application/admin\view\common\top.htm";i:1517578989;s:65:"E:\wamp64\www\test\b2cshop/application/admin\view\common\left.htm";i:1560414868;}*/ ?>
<!DOCTYPE html>
<html><head>
        <meta charset="utf-8">
                ...
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" placeholder="" name="cname" value="<?php echo $confs['cname']; ?>" required="" type="text">
                            </div>
                        ...
                        <div class="form-group">
                         ...
                         <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input name="value" class="form-control" value="<?php echo $confs['value']; ?>" placeholder="" type="text">
                            </div>
                        </div>
                        <div class="form-group">
