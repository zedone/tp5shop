<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:74:"E:\wamp64\www\test\b2cshop/application/admin\view\order\ordergoodsedit.htm";i:1560412035;s:64:"E:\wamp64\www\test\b2cshop/application/admin\view\common\top.htm";i:1517578989;s:65:"E:\wamp64\www\test\b2cshop/application/admin\view\common\left.htm";i:1560414868;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
                ...
                <div class="page-breadcrumbs">
                    <ul class="breadcrumb">
                        ...
                        <a href="<?php echo url('Index/index'); ?>">系统</a>
                                        ...
                                        <li>
                        <a href="<?php echo url('Order/orderGoods',['id'=>$orderGoodsInfo['order_id']]); ?>">订单商品管理</a>
                    </li>
        ...
        <div class="widget">
            ...
            <div class="widget-body">
                <div id="horizontal-form">
                    ...
                    <input type="text" name="id" value="<?php echo $orderGoodsInfo['id']; ?>">
                       
                        <div class="form-group">
                            <label for="username" class="col-sm-2 control-label no-padding-right">商品名称</label>
                            <div class="col-sm-6">
                                <input type="text"  value="<?php echo $orderGoodsInfo['goods_name']; ?>" class="form-control" name="goods_name">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="username" class="col-sm-2 control-label no-padding-right">会员价</label>
                            <div class="col-sm-6">
                                <input type="text" value="<?php echo $orderGoodsInfo['member_price']; ?>" class="form-control" name="member_price">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="username"  class="col-sm-2 control-label no-padding-right">本店价</label>
                            <div class="col-sm-6">
                                <input type="text" value="<?php echo $orderGoodsInfo['shop_price']; ?>" class="form-control" name="shop_price">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="username" class="col-sm-2 control-label no-padding-right">市场价</label>
                            <div class="col-sm-6">
                                <input type="text" value="<?php echo $orderGoodsInfo['market_price']; ?>" class="form-control" name="market_price">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input type="text" value="<?php echo $orderGoodsInfo['goods_num']; ?>" class="form-control" name="goods_num">
                            </div>
                        </div>
