<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:72:"D:\xammp\htdocs\test\b2cshop/application/member\view\order\orderlist.htm";i:1560949104;s:67:"D:\xammp\htdocs\test\b2cshop/application/index\view\common\head.htm";i:1526908574;s:69:"D:\xammp\htdocs\test\b2cshop/application/index\view\common\footer.htm";i:1522488208;}*/ ?>
<!doctype html>
<html>
<head>
...
<dl class="item">
    <dt class="item-t item-t-qb">
        <div class="t-statu">
            <div class="t-statu-name" id="ss_received_4">
                <?php
                    if($v['order_status']==0){
                        echo '未确认';
        ...
        <div class="t-info">
            ...
            <span class="info-item"><?php echo date("Y-m-d H:i",$v['order_time']); ?></span>
            <span class="info-item"><?php echo $v['name']; ?></span>    
        </div>
        <div class="t-price"><em>¥</em><?php echo $v['order_total_price']; ?></div>
    </dt>
    <?php 
    if(isset($orderRes[$k]['goods'])):
    foreach ($orderRes[$k]['goods'] as $k1 => $v1):
    ?>
    <dd class="item-c">
        <div class="c-left">
                        <div class="c-goods" ectype="c-goods">
                                    <div class="c-img"><a href="goods.php?id=734"><img src="__uploads__/<?php echo $v1['mid_thumb']; ?>" alt=""></a></div> 
                                <div class="c-info">
                    <div class="o-info-lm">
                                                <a href="goods.php?id=734" class="info-name" target="_blank" title="松桂坊湘西五花腊肉250g湖南特产香肠烟熏肉腊肠腊肉 湖南特产 腊肉饭 精选上等猪头"><?php echo $v1['goods_name']; ?></a>
                                            </div>
                    <div class="fl">
                    <div class="info-price mr10" style="width: auto;"><b><em>¥</em><?php echo $v1['shop_price']; ?></b><i>×</i><span><?php echo $v1['goods_num']; ?></span></div>
                                        </div>
                                    </div>
            </div>
                                </div>
        ...
        <?php if($k1==0):?>
        <div class="c-handle" id="ss_msg_4">
    <a href="<?php echo url('member/Order/orderDetail',['id'=>$v['id']]); ?>" class="sc-btn">订单详情</a>
        <a href="<?php echo url('member/Order/delOrder',['id'=>$v['id']]); ?>" onclick="if (!confirm('您确认要删除该订单吗？')) return false;" class="sc-btn">删除订单</a>
                            <a href="user.php?act=cancel_order&amp;order_id=4" onclick="if (!confirm('您确认要取消该订单吗？取消后此订单将视为无效订单')) return false;" class="sc-btn">取消订单</a>
...
<div class="pages pages_warp"><div class="item prev"><a href="javascript:user_order_gotoPage(0, 61, 0, 0);"><i class="iconfont icon-left"></i></a></div><div class="item cur"><a spellcheck="false">1</a></div> <div class="item next"><a href="javascript:user_order_gotoPage(1, 61, 0, 0);"><i class="iconfont icon-right"></i></a></div> </div>
