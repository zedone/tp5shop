<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:66:"D:\xammp\htdocs\test\b2cshop/application/index\view\flow\flow4.htm";i:1560243436;s:69:"D:\xammp\htdocs\test\b2cshop/application/index\view\common\footer.htm";i:1522488208;}*/ ?>
<!doctype html>
<html>
<head>
...
//加载效果
var load_cart_info = '<img src="__index__/img/images/load/loadGoods.gif" class="load" />';
var load_icon = '<img src="__index__/img/images/load/load.gif" width="200" height="200" />';
...
<div class="header header-cart">
    <div class="w w1200">
        <div class="logo">
            <div class="logoImg"><a href="index.php"><img src="__index__/img/images/logo.gif" /></a></div>
            ...
            <div class="payOrder-warp" id="pay_main">
                <div class="payOrder-desc">
                    ...
                    <div class="pay-txt">
                        ...
                        <p>您选定的支付方式为：<span id="paymode"><?php if($orderInfo['payment'] == 1): ?>支付宝支付<?php else: ?>微信支付<?php endif; ?></span></p>
                    ...
                    <img id="ewm" src="<?php echo url('index/Flow/wxewm',['outTradeNo'=>$orderInfo['out_trade_no']],''); ?>">
                </div>
...
<script type="text/javascript" src="__index__/js/warehouse.js"></script><script type="text/javascript" src="__index__/js/warehouse_area.js"></script>
	...
	<script type="text/javascript" src="__index__/img/js/dsc-common.js"></script>
    <script type="text/javascript" src="__index__/img/js/jquery.purebox.js"></script>
    <script type="text/javascript" src="__index__/img/js/region.js"></script>
        ...
        function my_monitor(){
            ...
            $.ajax({
               ...
               success:function(res) {
                if(res.pay_status==1){
                    $("#ewm").attr('src','http://www.test.com/b2cshop/public/static/index/img/支付成功.png');
                }
               }
           })
           
        };
		 setInterval("my_monitor()", 2000);
		var timer;
		function checkOrder(){
			var pay_name = "在线支付";
			var pay_status = "0";
