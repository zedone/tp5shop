<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:73:"E:\wamp64\www\test\b2cshop/application/admin\view\category_words\edit.htm";i:1516443796;s:64:"E:\wamp64\www\test\b2cshop/application/admin\view\common\top.htm";i:1517578989;s:65:"E:\wamp64\www\test\b2cshop/application/admin\view\common\left.htm";i:1560414868;}*/ ?>
<!DOCTYPE html>
<html><head>
        <meta charset="utf-8">
    ...
    <div class="col-lg-12 col-sm-12 col-xs-12">
        <div class="widget">
            <div class="widget-header bordered-bottom bordered-blue">
                <span class="widget-caption">修改关联词</span>
            </div>
                ...
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label for="username" class="col-sm-2 control-label no-padding-right">关联栏目</label>
                            <div class="col-sm-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" placeholder="" name="word" value="<?php echo $categoryWords['word']; ?>" required="" type="text">
                            </div>
                            <p class="help-block col-sm-4 red">* 必填</p>
                        </div>
                        <div class="form-group">
                            <label for="username" class="col-sm-2 control-label no-padding-right">关联网址</label>
                            <div class="col-sm-6">
