<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:73:"D:\xammp\htdocs\test\b2cshop/application/index\view\category\category.htm";i:1560854794;s:67:"D:\xammp\htdocs\test\b2cshop/application/index\view\common\head.htm";i:1526908574;s:68:"D:\xammp\htdocs\test\b2cshop/application/index\view\common\right.htm";i:1516076657;s:69:"D:\xammp\htdocs\test\b2cshop/application/index\view\common\footer.htm";i:1522488208;}*/ ?>
<!doctype html>
<html>
<head>  
...
<div class="ct_auto">
    ...
    <span class="no_bt botton">关闭</span>
            ...
            <li class="s-line">
                <dl class="s-l-wrap">
                    ...
                    <div class="s-l-value attr_son">
                        ...
                        <div class="price_range"><a <?php if(!input('price')){ echo 'class="btn sc-redBg-btn"';}?>
                        >不限</a>
                        <?php if(is_array($priceSection) || $priceSection instanceof \think\Collection || $priceSection instanceof \think\Paginator): $i = 0; $__LIST__ = $priceSection;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$price): $mod = ($i % 2 );++$i;?>
                            <div class="price_range"><a  <?php if(input('price')==$price){echo 'class="btn sc-redBg-btn"';}?> href="<?php echo url('index/Category/index',['id'=>input('id'),'price'=>$price],''); ?>#search"><?php echo $price; ?></a></div>
                        <?php endforeach; endif; else: echo "" ;endif; ?>
                        </div>
            ...
            <?php
            $attrCount=count($attrRes);
            if(!$attrCount){
                $attrCount=1;
            }
            $filterAttr=input('filter_attr');
            if($filterAttr){
                $attr_arr=explode('.',$filterAttr);
            }else{
                $attr_arr=array_fill(0,$attrCount,0);
            }
            ...
            <li class="s-line">
                <dl class="s-l-wrap">
                    <div class="s-l-tit filter_attr_name"><?php echo $v['attr_name']?></div>
                    <div class="s-l-value attr_son">
                        <div class="price_auto fl">
                        <div class="price_range"><a class="btn sc-redBg-btn" href="<?php $tmp_attr_arr=$attr_arr;$tmp_attr_arr[$k]=0; $_attr_str=implode('.', $tmp_attr_arr); echo url('index/Category/index',['id'=>input('id'),'filter_attr'=>$_attr_str],'');?>">不限</a></div>
                        <?php foreach($v['attr_values'] as $k1=>$v1):
                            $tmp_attr_arr=$attr_arr;
                            $tmp_attr_arr[$k]=$v1['attr_value'];
                            $attr_str=implode('.', $tmp_attr_arr);
                    
                        ?>
                            <div class="price_range"><a
                            href="<?php  
                                $urlArr=[];
                                $urlArr['id']=input('id');
                                $urlArr['filter_attr']=$attr_str;
                                input('price') ? $urlArr['price'] = input('price') :'' ;
                                echo url('index/Category/index',$urlArr,'');
                            ?>" 
                            ><?php echo $v1['attr_value']?></a></div>
                        <?php endforeach;?>
                        </div>
    ...
    <?php if($ob=='xl' && $ow=='desc'):?>
        <a href="<?php echo url('index/Category/index',['id'=>$cateId,'ob'=>'xl','ow'=>'asc'],''); ?>#search" class="curr">销量<i class="iconfont icon-arrow-up"></i></a>
    <?php elseif($ob=='xl' && $ow=='asc'):?>
        <a href="<?php echo url('index/Category/index',['id'=>$cateId,'ob'=>'xl','ow'=>'desc'], ''); ?>#search" class="curr">销量<i class="iconfont icon-arrow-down"></i></a>
    <?php else:?>
        <a href="<?php echo url('index/Category/index',['id'=>$cateId], ''); ?>#search" class="">销量<i class="iconfont icon-arrow-down"></i></a>
    <?php endif;if($ob=='time' && $ow=='desc'):?>
        <a href="<?php echo url('index/Category/index',['id'=>$cateId,'ob'=>'time','ow'=>'asc'],''); ?>#search" class="curr">新品<i class="iconfont icon-arrow-up"></i></a>
    <?php elseif($ob=='time' && $ow=='asc'):?>
        <a href="<?php echo url('index/Category/index',['id'=>$cateId,'ob'=>'time','ow'=>'desc'],''); ?>#search" class="curr">新品<i class="iconfont icon-arrow-down"></i></a>
    <?php else:?>
        <a href="<?php echo url('index/Category/index',['id'=>$cateId,'ob'=>'xl','ow'=>'asc'],''); ?>#search" class="">新品<i class="iconfont icon-arrow-down"></i></a>
    <?php endif;if($ob=='pl' && $ow=='desc'):?>
        <a href="<?php echo url('index/Category/index',['id'=>$cateId,'ob'=>'pl','ow'=>'asc'],''); ?>#search" class="curr">评论数<i class="iconfont icon-arrow-up"></i></a>
    <?php elseif($ob=='pl' && $ow=='asc'):?>
        <a href="<?php echo url('index/Category/index',['id'=>$cateId,'ob'=>'pl','ow'=>'desc'],''); ?>#search" class="curr">评论数<i class="iconfont icon-arrow-down"></i></a>
    <?php else:?>
        <a href="<?php echo url('index/Category/index',['id'=>$cateId,'ob'=>'pl','ow'=>'asc'],''); ?>#search" class="">评论数<i class="iconfont icon-arrow-down"></i></a>
    <?php endif;if($ob=='price' && $ow=='desc'):?>
        <a href="<?php echo url('index/Category/index',['id'=>$cateId,'ob'=>'price','ow'=>'asc'],''); ?>#search" class="curr">价格<i class="iconfont icon-arrow-up"></i></a>
    <?php elseif($ob=='price' && $ow=='asc'):?>
        <a href="<?php echo url('index/Category/index',['id'=>$cateId,'ob'=>'price','ow'=>'desc'],''); ?>#search" class="curr">价格<i class="iconfont icon-arrow-down"></i></a>
    <?php else:?>
        <a href="<?php echo url('index/Category/index',['id'=>$cateId,'ob'=>'price','ow'=>'asc'],''); ?>#search" class="">价格<i class="iconfont icon-arrow-down"></i></a>
    <?php endif;?>
    </div>
    ...
    <div class="goods-list" ectype="gMain">
                <div class="gl-warp gl-warp-large">
                        ...
                        <?php if(is_array($goodsRes) || $goodsRes instanceof \think\Collection || $goodsRes instanceof \think\Paginator): $i = 0; $__LIST__ = $goodsRes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$goods): $mod = ($i % 2 );++$i;?>
    				        <li class="gl-item">
                    <div class="gl-i-wrap">
                        <div class="p-img"><a href="#" target="_blank"><img src="__uploads__/<?php echo $goods['mid_thumb']; ?>" /></a></div>
                    <div class="sider">
                <a href="#" class="sider-prev"><i class="iconfont icon-left"></i></a>
        <ul>
            <li  class="curr"><img src="__uploads__/<?php echo $goods['mid_thumb']; ?>" width="26" height="26" /></li>
            <?php if($goods['mid_photo']):
                $photoArr=explode(',',$goods['mid_photo']);
                foreach($photoArr as $v):
            ?>
                <li ><img src="__uploads__/<?php echo $v; ?>" width="26" height="26" /></li>
            <?php endforeach; endif;?>
                    ...
                    <div class="p-lie">
<div class="p-price">
            <em>¥</em><?php echo $goods['price']; ?>    </div>
<div class="p-num">已售<em><?php echo $goods['xl']; ?></em>件<em><?php echo $goods['pl']; ?></em>评论</div>
                        </div>
                        <div class="p-name"><a href="#" target="_blank"><?php echo $goods['goods_name']; ?></a></div>
...
<li class="opacity_img">
                <div class="">
                        <div class="p-img"><a href="#" target="_blank"><img src="" width="190" height="190"></a></div>
                        <div class="p-price">
                        <em>¥</em>148.00                    </div>
...
<li class="opacity_img">
                <div class="">
                        <div class="p-img"><a href="#" target="_blank"><img src="__uploads__/<?php echo $goods['sm_thumb']; ?>" width="190" height="190"></a></div>
                        <div class="p-price">
                        <em>¥</em>149.00                    </div>
