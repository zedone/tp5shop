<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:74:"D:\xammp\htdocs\test\b2cshop/application/member\view\order\orderdetail.htm";i:1560932150;s:67:"D:\xammp\htdocs\test\b2cshop/application/index\view\common\head.htm";i:1526908574;s:69:"D:\xammp\htdocs\test\b2cshop/application/index\view\common\footer.htm";i:1522488208;}*/ ?>
<!doctype html>
<html>
<head>
...
<dd>
   ...
   <div class="user-mod user-order-detail" style="min-height: 1018px;">
            <div class="user-title">
                <h2>订单详情</h2>
                <a href="user.php?act=message_list&amp;is_order=1&amp;order_id=5" class="more">留言<em>&nbsp;&nbsp;(&nbsp;0&nbsp;)</em></a>
            </div>
            <div class="order-detail-statu">
                <div class="statu-left">
                    <p> 
                    <?php if($orderLists['pay_status'] == 1): ?>
                        已支付
                    <?php else: ?>
                        未支付
                    <?php endif; ?>
                    <span style="color: deepskyblue;"></span></p>
                    <p>订单号：<?php echo $orderLists['out_trade_no']; ?>                   
                    </p>
                </div>
            ...
            <ul class="order-detail-progress progress-1">
                <li>下单时间<div class="tip"><?php echo date("Y-m-d  H:i",$orderLists['order_time']); ?></div></li>
                <li>付款<div class="tip"></div></li>
                <li>发货<div class="tip"></div></li>
                <li>收货<div class="tip"></div></li>
            ...
            <div class="user-info-list">
                ...
                <div class="info-content">
                    <div class="info-item">
                        ...
                        <div class="item-value"><?php echo $orderLists['name']; ?></div>
                    </div>
                    <div class="info-item">
                        <div class="item-label">手机号码：</div>
                        <div class="item-value"><?php echo $orderLists['phone']; ?></div>
                    </div>
                    <div class="info-item">
                        <div class="item-label">收货地址：</div>
                        <div class="item-value"><?php echo $orderLists['province']; ?>  <?php echo $orderLists['city']; ?>  &nbsp;<?php echo $orderLists['address']; ?></div>
                    </div>
                </div>
            </div>
                ...
                <div class="info-title"><h2>付款信息</h2></div>
                    ...
                    <div class="info-item">
                        ...
                        <div class="item-value"> 
                            <?php if($orderLists['payment'] == 1): ?>
                                支付宝
                            <?php elseif($orderLists['payment'] == 2): ?>
                                微信
                            <?php else: ?>
                                余额
                            <?php endif; ?>
                                    ...
                                    <div class="item-value">
                                        <form name="payment" method="post" action="user.php">
                                            ...
                                            <input type="submit" name="Submit" class="btn sc-redBg-btn btn30 ml5" value="确定">
                                        </form>
                                    </div>
                                </div>
                ...
                <div class="info-content">
                    <div class="info-item">
                        <div class="item-label">配送方式：</div>
                            <div class="item-value" id="shipping_name_5">
                                <?php echo $orderLists['distribution']; ?>
                            </div>
                        ...
                        <div class="item-value">
                            <?php if($orderLists['post_status'] == 0): ?>
                                未发货
                            <?php elseif($orderLists['post_status'] == 1): ?>
                                已发货
                            <?php else: ?>
                                已收货
                            <?php endif; ?>                            
            ...
            <table class="user-table user-table-detail-goods">
                ...
                <tbody>
                    <tr>
                        <td>
                            <a href="goods.php?id=847" class="img"><img src="__uploads__/<?php echo $vo['sm_thumb']; ?>" alt=""></a>
                                                                            
                            <a href="goods.php?id=847" class="name"><?php echo $vo['goods_name']; ?></a>
                            <p class="fl ftx-05">商品赠送积分：0</p>
                                                     
                             
                        </td>
                        <td><?php echo $vo['goods_attr_str']; ?></td>
                        <td>ECS000847</td>
                        <td>北京仓库</td>
                        <td><p><em>¥</em><?php echo $vo['shop_price']; ?></p><p><?php echo $vo['goods_num']; ?></p></td>
                        <td>
                            <p class="ftx-01"><em>¥</em><?php echo $vo['shop_price']; ?></p>
                                                    </td>
                    </tr>
                </tbody>
                <?php endforeach; endif; else: echo "" ;endif; ?>
                    ...
                    <dd class="total-value">1件</dd>
                </dl>
                                <dl class="total-row">
                    <dt class="total-label">商品总价：</dt>
                    <dd class="total-value"><em>¥</em>179.00</dd>
                </dl>
                                                                                                
                                                <dl class="total-row">
                    <dt class="total-label">配送费用：</dt>
                    <dd class="total-value">+ <em>¥</em>4.30</dd>
                </dl>
                                                                                                                <dl class="total-row">
                    <dt class="total-label">
                                                                        应付款：
                                                                </dt>
                    <dd class="total-value"><em>¥</em><?php echo $orderLists['order_total_price']; ?></dd>
                </dl>
            </div>
        </div>
</div>
