<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:70:"E:\wamp64\www\test\b2cshop/application/admin\view\order\ordergoods.htm";i:1560412009;s:64:"E:\wamp64\www\test\b2cshop/application/admin\view\common\top.htm";i:1517578989;s:65:"E:\wamp64\www\test\b2cshop/application/admin\view\common\left.htm";i:1560414868;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
                        ...
                        <tbody>
                            <?php if(is_array($orderGoodsRes) || $orderGoodsRes instanceof \think\Collection || $orderGoodsRes instanceof \think\Paginator): $i = 0; $__LIST__ = $orderGoodsRes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$orderGoods): $mod = ($i % 2 );++$i;?>
                                <tr>
                                    ...
                                    <td align="center"><?php echo cut_str($orderGoods['goods_name'],10); ?></td>
