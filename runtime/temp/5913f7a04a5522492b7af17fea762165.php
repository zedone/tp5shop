<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:66:"D:\xammp\htdocs\test\b2cshop/application/index\view\flow\flow2.htm";i:1560166853;s:69:"D:\xammp\htdocs\test\b2cshop/application/index\view\common\footer.htm";i:1522488208;}*/ ?>
...
<span>3.成功提交订单</span>
        ...
        <form action="<?php echo url('Flow/flow3'); ?>" method="post" name="doneTheForm" class="validator" id="theForm">
            <div class="w w1200">
    ...
    <div class="ck-step-cont">
        <div class="payment-warp">
            <div class="payment-list" ectype="paymentType">
                <div class="p-radio-item payment-item" data-value='{"type":"cod","payid":"16","allow":""}'>
                    <span>
                        <input type="radio" value="韵达" name="distribution" />韵达     
                    </span>
                    <b></b>
                </div>
                <div class="p-radio-item payment-item" data-value='{"type":"cod","payid":"16","allow":""}'>
                    <span>
                        <input type="radio" value="申通" name="distribution" />申通    
                    </span>
                    <b></b>
                </div>
            </div>
